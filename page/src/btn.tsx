export const RunButton = (props: {
  ...
  <button
    ...
    class="w-full justify-center px-4 py-2.5 bg-green-600/90 hover:bg-green-500 text-white text-sm font-semibold rounded-lg shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500/60 flex items-center gap-2 whitespace-nowrap disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:bg-green-600/90"
  >
    <svg
  ...
  return (
    <button
      ...
      onClick={() => {
        ...
        void props.download("/target/wasm32-wasip1/debug/main.wasm").catch(
          console.error,
        );
      }}
    ...
    >
      <svg
        class="w-4 h-4 text-gray-400 group-hover:text-white flex-shrink-0"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >

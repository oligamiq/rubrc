...
export function instantiate(getCoreModule, imports, instantiateCore = WebAssembly.instantiate) {
  ...
  function _lowerImportBackwardsCompat(args) {
    ...
    function _liftFlatS8(ctx) {
      _debugLog('[_liftFlatS8()] args', { ctx });
      let val;
    ...
    function _lowerFlatS32(ctx) {
      _debugLog('[_lowerFlatS32()] args', { ctx });
      ...
      _requireValidNumericPrimitive.bind('s32', ctx.vals[0]);
    ...
    const { ChildProcess, Downloader, Http, Terminal } = imports['vfs:host/bridge'];

    if (ChildProcess=== undefined) {
      const err = new Error("unexpectedly undefined instance import 'ChildProcess', was 'ChildProcess' available at instantiation?");
    ...
    if (Http=== undefined) {
      const err = new Error("unexpectedly undefined instance import 'Http', was 'Http' available at instantiation?");
      console.error("ERROR:", err.toString());
      throw err;
    }
    ...
    if (Wasip1=== undefined) {
      const err = new Error("unexpectedly undefined instance import 'Wasip1', was 'Wasip1' available at instantiation?");
      console.error("ERROR:", err.toString());
      throw err;
    }
    ...
    if (Wasip1Threads=== undefined) {
      const err = new Error("unexpectedly undefined instance import 'Wasip1Threads', was 'Wasip1Threads' available at instantiation?");
      console.error("ERROR:", err.toString());
      throw err;
    }
    ...
    let gen = (function* _initGenerator () {
      ...
      const _trampoline0 = function(arg0) {
        _debugLog('[iface="vfs:host/bridge", function="[static]child-process.request-end"] [Instruction::CallInterface] (sync, @ enter)');
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'ChildProcess.requestEnd',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => ChildProcess.requestEnd(arg0 >>> 0),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="vfs:host/bridge", function="[static]child-process.request-end"][Instruction::Return]', {
          funcName: '[static]child-process.request-end',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline0.fnName = 'vfs:host/bridge#ChildProcess.requestEnd';

      const _trampoline1 = function(arg0, arg1, arg2) {
        _debugLog('[iface="vfs:host/bridge", function="[static]terminal.terminal-write"] [Instruction::CallInterface] (sync, @ enter)');
        const hostProvided = true;
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Terminal.terminalWrite',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Terminal.terminalWrite(arg0 >>> 0, arg1, arg2),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="vfs:host/bridge", function="[static]terminal.terminal-write"][Instruction::Return]', {
          funcName: '[static]terminal.terminal-write',
          paramCount: 0,
          async: false,
          postReturn: false
        });
      ...
      _trampoline1.fnName = 'vfs:host/bridge#Terminal.terminalWrite';

      const _trampoline2 = function(arg0, arg1, arg2, arg3) {
        _debugLog('[iface="vfs:host/bridge", function="[static]child-process.request-recover"] [Instruction::CallInterface] (sync, @ enter)');
        const hostProvided = true;
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'ChildProcess.requestRecover',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => ChildProcess.requestRecover(arg0, arg1, arg2, arg3),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="vfs:host/bridge", function="[static]child-process.request-recover"][Instruction::Return]', {
          funcName: '[static]child-process.request-recover',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline2.fnName = 'vfs:host/bridge#ChildProcess.requestRecover';

      const _trampoline3 = function(arg0) {
        _debugLog('[iface="vfs:host/bridge", function="[static]downloader.sysroot-get-archive-meta"] [Instruction::CallInterface] (sync, @ enter)');
        const hostProvided = true;
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Downloader.sysrootGetArchiveMeta',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Downloader.sysrootGetArchiveMeta(arg0),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="vfs:host/bridge", function="[static]downloader.sysroot-get-archive-meta"][Instruction::Return]', {
          funcName: '[static]downloader.sysroot-get-archive-meta',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline3.fnName = 'vfs:host/bridge#Downloader.sysrootGetArchiveMeta';

      const _trampoline4 = function(arg0, arg1) {
        _debugLog('[iface="vfs:host/bridge", function="[static]downloader.sysroot-read-archive-chunk"] [Instruction::CallInterface] (sync, @ enter)');
        const hostProvided = true;
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Downloader.sysrootReadArchiveChunk',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Downloader.sysrootReadArchiveChunk(arg0, arg1),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="vfs:host/bridge", function="[static]downloader.sysroot-read-archive-chunk"][Instruction::Return]', {
          funcName: '[static]downloader.sysroot-read-archive-chunk',
          paramCount: 0,
          async: false,
          postReturn: false
        });
      ...
      _trampoline4.fnName = 'vfs:host/bridge#Downloader.sysrootReadArchiveChunk';
      ...
      const _trampoline5 = function(arg0, arg1) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Downloader.sysrootStartFetch',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Downloader.sysrootStartFetch(arg0, arg1),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="vfs:host/bridge", function="[static]downloader.sysroot-start-fetch"][Instruction::Return]', {
          funcName: '[static]downloader.sysroot-start-fetch',
          paramCount: 0,
          async: false,
          postReturn: false
        });
      ...
      _trampoline5.fnName = 'vfs:host/bridge#Downloader.sysrootStartFetch';

      const _trampoline6 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12) {
        _debugLog('[iface="vfs:host/bridge", function="[static]http.request-start"] [Instruction::CallInterface] (sync, @ enter)');
        const hostProvided = true;
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Http.requestStart(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="vfs:host/bridge", function="[static]http.request-start"][Instruction::Return]', {
          funcName: '[static]http.request-start',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline6.fnName = 'vfs:host/bridge#Http.requestStart';

      const _trampoline7 = function(arg0, arg1, arg2) {
        _debugLog('[iface="vfs:host/bridge", function="[static]http.response-read-headers"] [Instruction::CallInterface] (sync, @ enter)');
        const hostProvided = true;
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Http.responseReadHeaders',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Http.responseReadHeaders(arg0 >>> 0, arg1, arg2),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="vfs:host/bridge", function="[static]http.response-read-headers"][Instruction::Return]', {
          funcName: '[static]http.response-read-headers',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline7.fnName = 'vfs:host/bridge#Http.responseReadHeaders';

      const _trampoline8 = function(arg0, arg1, arg2) {
        _debugLog('[iface="vfs:host/bridge", function="[static]http.response-read-body"] [Instruction::CallInterface] (sync, @ enter)');
        const hostProvided = true;
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Http.responseReadBody',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Http.responseReadBody(arg0 >>> 0, arg1, arg2),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="vfs:host/bridge", function="[static]http.response-read-body"][Instruction::Return]', {
          funcName: '[static]http.response-read-body',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline8.fnName = 'vfs:host/bridge#Http.responseReadBody';

      const _trampoline9 = function(arg0, arg1, arg2) {
        _debugLog('[iface="vfs:host/bridge", function="[static]http.response-read-error"] [Instruction::CallInterface] (sync, @ enter)');
        const hostProvided = true;
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Http.responseReadError',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Http.responseReadError(arg0 >>> 0, arg1, arg2),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="vfs:host/bridge", function="[static]http.response-read-error"][Instruction::Return]', {
          funcName: '[static]http.response-read-error',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline9.fnName = 'vfs:host/bridge#Http.responseReadError';

      const _trampoline10 = function(arg0) {
        _debugLog('[iface="vfs:host/bridge", function="[static]http.response-end"] [Instruction::CallInterface] (sync, @ enter)');
        const hostProvided = true;
        ...
        _debugLog('[iface="vfs:host/bridge", function="[static]http.response-end"][Instruction::Return]', {
          funcName: '[static]http.response-end',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline10.fnName = 'vfs:host/bridge#Http.responseEnd';

      const _trampoline11 = function(arg0, arg1, arg2, arg3, arg4, arg5) {
        _debugLog('[iface="vfs:host/bridge", function="[static]child-process.request-start"] [Instruction::CallInterface] (sync, @ enter)');
        const hostProvided = true;
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'ChildProcess.requestStart',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => ChildProcess.requestStart(arg0, arg1, arg2, arg3, arg4, arg5),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="vfs:host/bridge", function="[static]child-process.request-start"][Instruction::Return]', {
          funcName: '[static]child-process.request-start',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      const _trampoline14 = function(arg0, arg1, arg2) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'ChildProcess.requestWrite',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => ChildProcess.requestWrite(arg0 >>> 0, arg1, arg2),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="vfs:host/bridge", function="[static]child-process.request-write"][Instruction::Return]', {
          funcName: '[static]child-process.request-write',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline15.fnName = 'vfs:host/bridge#Downloader.downloadFileStart';
      ...
      _trampoline16.fnName = 'vfs:host/bridge#Downloader.downloadFileChunk';
      ...
      const _trampoline20 = function(arg0) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1Threads.threadSpawnImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1Threads.threadSpawnImport(arg0),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-threads-import", function="[static]wasip1-threads.thread-spawn-import"][Instruction::Return]', {
          funcName: '[static]wasip1-threads.thread-spawn-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline20.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-threads-import#Wasip1Threads.threadSpawnImport';
      ...
      const _trampoline21 = function(arg0, arg1) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.randomGetImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1.randomGetImport(arg0, arg1),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.random-get-import"][Instruction::Return]', {
          funcName: '[static]wasip1.random-get-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline21.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.randomGetImport';
      ...
      _trampoline22.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.schedYieldImport';
      ...
      const _trampoline23 = function(arg0, arg1) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.clockResGetImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1.clockResGetImport(arg0, arg1),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.clock-res-get-import"][Instruction::Return]', {
          funcName: '[static]wasip1.clock-res-get-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline23.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.clockResGetImport';
      ...
      const _trampoline24 = function(arg0, arg1, arg2) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.clockTimeGetImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1.clockTimeGetImport(arg0, arg1, arg2),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.clock-time-get-import"][Instruction::Return]', {
          funcName: '[static]wasip1.clock-time-get-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline24.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.clockTimeGetImport';
      ...
      const _trampoline25 = function(arg0, arg1) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.environGetImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1.environGetImport(arg0, arg1),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.environ-get-import"][Instruction::Return]', {
          funcName: '[static]wasip1.environ-get-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline25.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.environGetImport';
      ...
      const _trampoline26 = function(arg0, arg1) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.environSizesGetImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1.environSizesGetImport(arg0, arg1),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.environ-sizes-get-import"][Instruction::Return]', {
          funcName: '[static]wasip1.environ-sizes-get-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline26.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.environSizesGetImport';
      ...
      const _trampoline27 = function(arg0) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.fdCloseImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.fd-close-import"][Instruction::Return]', {
          funcName: '[static]wasip1.fd-close-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline27.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.fdCloseImport';
      ...
      const _trampoline28 = function(arg0, arg1) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.fdFdstatGetImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1.fdFdstatGetImport(arg0, arg1),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.fd-fdstat-get-import"][Instruction::Return]', {
          funcName: '[static]wasip1.fd-fdstat-get-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline28.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.fdFdstatGetImport';
      ...
      const _trampoline29 = function(arg0, arg1) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.fdFilestatGetImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1.fdFilestatGetImport(arg0, arg1),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.fd-filestat-get-import"][Instruction::Return]', {
          funcName: '[static]wasip1.fd-filestat-get-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline29.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.fdFilestatGetImport';
      ...
      const _trampoline30 = function(arg0, arg1) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.fdPrestatGetImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1.fdPrestatGetImport(arg0, arg1),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.fd-prestat-get-import"][Instruction::Return]', {
          funcName: '[static]wasip1.fd-prestat-get-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline30.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.fdPrestatGetImport';
      ...
      const _trampoline31 = function(arg0, arg1, arg2) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.fdPrestatDirNameImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1.fdPrestatDirNameImport(arg0, arg1, arg2),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.fd-prestat-dir-name-import"][Instruction::Return]', {
          funcName: '[static]wasip1.fd-prestat-dir-name-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline31.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.fdPrestatDirNameImport';

      const _trampoline32 = function(arg0, arg1, arg2, arg3, arg4) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.fdReaddirImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1.fdReaddirImport(arg0, arg1, arg2, arg3, arg4),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.fd-readdir-import"][Instruction::Return]', {
          funcName: '[static]wasip1.fd-readdir-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline32.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.fdReaddirImport';

      const _trampoline33 = function(arg0, arg1, arg2, arg3) {
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.fd-seek-import"] [Instruction::CallInterface] (sync, @ enter)');
        const hostProvided = true;
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.fdSeekImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1.fdSeekImport(arg0, arg1, clampGuest(arg2, -128, 127), arg3),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.fd-seek-import"][Instruction::Return]', {
          funcName: '[static]wasip1.fd-seek-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline33.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.fdSeekImport';

      const _trampoline34 = function(arg0) {
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.fd-sync-import"] [Instruction::CallInterface] (sync, @ enter)');
        const hostProvided = true;
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.fdSyncImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.fd-sync-import"][Instruction::Return]', {
          funcName: '[static]wasip1.fd-sync-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline34.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.fdSyncImport';
      ...
      const _trampoline35 = function(arg0, arg1, arg2) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.pathCreateDirectoryImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1.pathCreateDirectoryImport(arg0, arg1, arg2),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.path-create-directory-import"][Instruction::Return]', {
          funcName: '[static]wasip1.path-create-directory-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline35.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.pathCreateDirectoryImport';

      const _trampoline36 = function(arg0, arg1, arg2, arg3, arg4) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.pathFilestatGetImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1.pathFilestatGetImport(arg0, arg1, arg2, arg3, arg4),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.path-filestat-get-import"][Instruction::Return]', {
          funcName: '[static]wasip1.path-filestat-get-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline36.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.pathFilestatGetImport';

      const _trampoline37 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.pathOpenImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1.pathOpenImport(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.path-open-import"][Instruction::Return]', {
          funcName: '[static]wasip1.path-open-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline37.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.pathOpenImport';

      const _trampoline38 = function(arg0, arg1, arg2) {
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.path-remove-directory-import"] [Instruction::CallInterface] (sync, @ enter)');
        const hostProvided = true;
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.pathRemoveDirectoryImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1.pathRemoveDirectoryImport(arg0, arg1, arg2),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.path-remove-directory-import"][Instruction::Return]', {
          funcName: '[static]wasip1.path-remove-directory-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline38.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.pathRemoveDirectoryImport';

      const _trampoline39 = function(arg0, arg1, arg2) {
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.path-unlink-file-import"] [Instruction::CallInterface] (sync, @ enter)');
        const hostProvided = true;
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.pathUnlinkFileImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        try {
          ret = _withGlobalCurrentTaskMeta({
            componentIdx: task.componentIdx(),
            taskID: task.id(),
            fn: () => Wasip1.pathUnlinkFileImport(arg0, arg1, arg2),
          })
          ;
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.path-unlink-file-import"][Instruction::Return]', {
          funcName: '[static]wasip1.path-unlink-file-import',
          paramCount: 1,
          async: false,
          postReturn: false
        });
      ...
      _trampoline39.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.pathUnlinkFileImport';
      ...
      const _trampoline40 = function(arg0) {
        ...
        const createTask = () => {
          const results = createNewCurrentTask({
            componentIdx: -1,
            isAsync: false,
            entryFnName: 'Wasip1.procExitImport',
            getCallbackFn: () => null,
            callbackFnName: null,
            errHandling: 'none',
            callingWasmExport: false,
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-core", function="[static]wasip1.proc-exit-import"][Instruction::Return]', {
          funcName: '[static]wasip1.proc-exit-import',
          paramCount: 0,
          async: false,
          postReturn: false
        });
      ...
      _trampoline40.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.procExitImport';
      let exports0;
      let exports0FlushToVfs;

      function flushToVfs() {
        _debugLog('[iface="flush-to-vfs", function="flush-to-vfs"][Instruction::CallWasm] enter', {
          funcName: 'flush-to-vfs',
          paramCount: 0,
          async: false,
          postReturn: false,
        });
        ...
        const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
          ...
          isAsync: false,
          isManualAsync: false,
          entryFnName: 'exports0FlushToVfs',
          getCallbackFn: () => null,
          callbackFnName: null,
          errHandling: 'none',
        ...
        _debugLog('[iface="flush-to-vfs", function="flush-to-vfs"][Instruction::Return]', {
          funcName: 'flush-to-vfs',
          paramCount: 0,
          async: false,
          postReturn: false
      ...
      let exports0FlushFromVfs;

      function flushFromVfs() {
        _debugLog('[iface="flush-from-vfs", function="flush-from-vfs"][Instruction::CallWasm] enter', {
          funcName: 'flush-from-vfs',
          paramCount: 0,
          async: false,
          postReturn: false,
        });
        ...
        const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
          ...
          isAsync: false,
          isManualAsync: false,
          entryFnName: 'exports0FlushFromVfs',
          getCallbackFn: () => null,
          callbackFnName: null,
          errHandling: 'none',
          callingWasmExport: true,
        ...
        _debugLog('[iface="flush-from-vfs", function="flush-from-vfs"][Instruction::Return]', {
          funcName: 'flush-from-vfs',
          paramCount: 0,
          async: false,
          postReturn: false
      ...
      let exports0StartupSysrootLoadState;

      function startupSysrootLoadState(arg0) {
        _debugLog('[iface="startup-sysroot-load-state", function="startup-sysroot-load-state"][Instruction::CallWasm] enter', {
          funcName: 'startup-sysroot-load-state',
          paramCount: 1,
          async: false,
          postReturn: false,
        });
        ...
        const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
          ...
          isAsync: false,
          isManualAsync: false,
          entryFnName: 'exports0StartupSysrootLoadState',
          getCallbackFn: () => null,
          callbackFnName: null,
          errHandling: 'none',
          callingWasmExport: true,
        ...
        try {
          ret =   _withGlobalCurrentTaskMeta({
            taskID: task.id(),
            componentIdx: task.componentIdx(),
            fn: () => exports0StartupSysrootLoadState(toUint32(arg0)),
          });
        } catch (err) {
        ...
        _debugLog('[iface="startup-sysroot-load-state", function="startup-sysroot-load-state"][Instruction::Return]', {
          funcName: 'startup-sysroot-load-state',
          paramCount: 1,
          async: false,
          postReturn: false
      ...
      let exports0StartupSysrootErrorCode;

      function startupSysrootErrorCode(arg0) {
        _debugLog('[iface="startup-sysroot-error-code", function="startup-sysroot-error-code"][Instruction::CallWasm] enter', {
          funcName: 'startup-sysroot-error-code',
          paramCount: 1,
          async: false,
          postReturn: false,
        });
        ...
        const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
          ...
          isAsync: false,
          isManualAsync: false,
          entryFnName: 'exports0StartupSysrootErrorCode',
          getCallbackFn: () => null,
          callbackFnName: null,
          errHandling: 'none',
          callingWasmExport: true,
        ...
        try {
          ret =   _withGlobalCurrentTaskMeta({
            taskID: task.id(),
            componentIdx: task.componentIdx(),
            fn: () => exports0StartupSysrootErrorCode(toUint32(arg0)),
          });
        } catch (err) {
        ...
        _debugLog('[iface="startup-sysroot-error-code", function="startup-sysroot-error-code"][Instruction::Return]', {
          funcName: 'startup-sysroot-error-code',
          paramCount: 1,
          async: false,
          postReturn: false
      ...
      let exports0AdditionalSysrootRegister;

      function additionalSysrootRegister() {
        _debugLog('[iface="additional-sysroot-register", function="additional-sysroot-register"][Instruction::CallWasm] enter', {
          funcName: 'additional-sysroot-register',
          paramCount: 0,
          async: false,
          postReturn: false,
        });
        ...
        const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
          ...
          isAsync: false,
          isManualAsync: false,
          entryFnName: 'exports0AdditionalSysrootRegister',
          getCallbackFn: () => null,
          callbackFnName: null,
          errHandling: 'none',
          callingWasmExport: true,
        ...
        try {
          ret =   _withGlobalCurrentTaskMeta({
            taskID: task.id(),
            componentIdx: task.componentIdx(),
            fn: () => exports0AdditionalSysrootRegister(),
          });
        } catch (err) {
        ...
        _debugLog('[iface="additional-sysroot-register", function="additional-sysroot-register"][Instruction::Return]', {
          funcName: 'additional-sysroot-register',
          paramCount: 1,
          async: false,
          postReturn: false
      ...
      let exports0AdditionalSysrootState;

      function additionalSysrootState(arg0) {
        _debugLog('[iface="additional-sysroot-state", function="additional-sysroot-state"][Instruction::CallWasm] enter', {
          funcName: 'additional-sysroot-state',
          paramCount: 1,
          async: false,
          postReturn: false,
        });
        ...
        const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
          ...
          isAsync: false,
          isManualAsync: false,
          entryFnName: 'exports0AdditionalSysrootState',
          getCallbackFn: () => null,
          callbackFnName: null,
          errHandling: 'none',
          callingWasmExport: true,
        ...
        try {
          ret =   _withGlobalCurrentTaskMeta({
            taskID: task.id(),
            componentIdx: task.componentIdx(),
            fn: () => exports0AdditionalSysrootState(toUint32(arg0)),
          });
        } catch (err) {
        ...
        _debugLog('[iface="additional-sysroot-state", function="additional-sysroot-state"][Instruction::Return]', {
          funcName: 'additional-sysroot-state',
          paramCount: 1,
          async: false,
          postReturn: false
      ...
      let exports0AdditionalSysrootErrorCode;

      function additionalSysrootErrorCode(arg0) {
        _debugLog('[iface="additional-sysroot-error-code", function="additional-sysroot-error-code"][Instruction::CallWasm] enter', {
          funcName: 'additional-sysroot-error-code',
          paramCount: 1,
          async: false,
          postReturn: false,
        });
        ...
        const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
          ...
          isAsync: false,
          isManualAsync: false,
          entryFnName: 'exports0AdditionalSysrootErrorCode',
          getCallbackFn: () => null,
          callbackFnName: null,
          errHandling: 'none',
          callingWasmExport: true,
        ...
        try {
          ret =   _withGlobalCurrentTaskMeta({
            taskID: task.id(),
            componentIdx: task.componentIdx(),
            fn: () => exports0AdditionalSysrootErrorCode(toUint32(arg0)),
          });
        } catch (err) {
        ...
        _debugLog('[iface="additional-sysroot-error-code", function="additional-sysroot-error-code"][Instruction::Return]', {
          funcName: 'additional-sysroot-error-code',
          paramCount: 1,
          async: false,
          postReturn: false
      ...
      let exports0AdditionalSysrootCancel;

      function additionalSysrootCancel(arg0) {
        _debugLog('[iface="additional-sysroot-cancel", function="additional-sysroot-cancel"][Instruction::CallWasm] enter', {
          funcName: 'additional-sysroot-cancel',
          paramCount: 1,
          async: false,
          postReturn: false,
        });
        ...
        const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
          ...
          isAsync: false,
          isManualAsync: false,
          entryFnName: 'exports0AdditionalSysrootCancel',
          getCallbackFn: () => null,
          callbackFnName: null,
          errHandling: 'none',
          callingWasmExport: true,
        ...
        try {
          ret =   _withGlobalCurrentTaskMeta({
            taskID: task.id(),
            componentIdx: task.componentIdx(),
            fn: () => exports0AdditionalSysrootCancel(toUint32(arg0)),
          });
        } catch (err) {
        ...
        _debugLog('[iface="additional-sysroot-cancel", function="additional-sysroot-cancel"][Instruction::Return]', {
          funcName: 'additional-sysroot-cancel',
          paramCount: 1,
          async: false,
          postReturn: false
      ...
      let exports0AdditionalSysrootRelease;

      function additionalSysrootRelease(arg0) {
        _debugLog('[iface="additional-sysroot-release", function="additional-sysroot-release"][Instruction::CallWasm] enter', {
          funcName: 'additional-sysroot-release',
          paramCount: 1,
          async: false,
          postReturn: false,
        });
        ...
        const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
          ...
          isAsync: false,
          isManualAsync: false,
          entryFnName: 'exports0AdditionalSysrootRelease',
          getCallbackFn: () => null,
          callbackFnName: null,
          errHandling: 'none',
          callingWasmExport: true,
        ...
        try {
          ret =   _withGlobalCurrentTaskMeta({
            taskID: task.id(),
            componentIdx: task.componentIdx(),
            fn: () => exports0AdditionalSysrootRelease(toUint32(arg0)),
          });
        } catch (err) {
        ...
        _debugLog('[iface="additional-sysroot-release", function="additional-sysroot-release"][Instruction::Return]', {
          funcName: 'additional-sysroot-release',
          paramCount: 1,
          async: false,
          postReturn: false
      ...
      let exports0Dispatch;

      function dispatch(arg0, arg1, arg2, arg3) {
        _debugLog('[iface="dispatch", function="dispatch"][Instruction::CallWasm] enter', {
          funcName: 'dispatch',
          paramCount: 4,
          async: false,
          postReturn: false,
        ...
        try {
          _withGlobalCurrentTaskMeta({
            taskID: task.id(),
            componentIdx: task.componentIdx(),
            fn: () => exports0Dispatch(toUint32(arg0), toUint32(arg1), toUint32(arg2), toUint32(arg3)),
          });
        } catch (err) {
        ...
        _debugLog('[iface="dispatch", function="dispatch"][Instruction::Return]', {
          funcName: 'dispatch',
          paramCount: 0,
          async: false,
          postReturn: false
      ...
      function init() {
        _debugLog('[iface="init", function="init"][Instruction::CallWasm] enter', {
          funcName: 'init',
          paramCount: 0,
          async: false,
          postReturn: false,
        ...
        _debugLog('[iface="init", function="init"][Instruction::Return]', {
          funcName: 'init',
          paramCount: 0,
          async: false,
          postReturn: false
      ...
      let virtualFileSystemWasip1ThreadsExportWasiThreadStart;

      function wasiThreadStart(arg0, arg1) {
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-threads-export", function="wasi-thread-start"][Instruction::CallWasm] enter', {
          funcName: 'wasi-thread-start',
          paramCount: 2,
          async: false,
          postReturn: false,
        });
        ...
        const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
          ...
          isAsync: false,
          isManualAsync: false,
          entryFnName: 'virtualFileSystemWasip1ThreadsExportWasiThreadStart',
          getCallbackFn: () => null,
          callbackFnName: null,
          errHandling: 'none',
          callingWasmExport: true,
        ...
        try {
          _withGlobalCurrentTaskMeta({
            taskID: task.id(),
            componentIdx: task.componentIdx(),
            fn: () => virtualFileSystemWasip1ThreadsExportWasiThreadStart(toInt32(arg0), toInt32(arg1)),
          });
        } catch (err) {
        ...
        _debugLog('[iface="wasip1-vfs:host/virtual-file-system-wasip1-threads-export", function="wasi-thread-start"][Instruction::Return]', {
          funcName: 'wasi-thread-start',
          paramCount: 0,
          async: false,
          postReturn: false
      ...
      null,
      {
        ...
        paramLiftFns: [_liftFlatU32,_liftFlatS32,_liftFlatS32],
        resultLowerFns: [],
        hasResultPointer: false,
        funcTypeIsAsync: false,
        getCallbackFn: () => null,
      ...
      null,
      {
        ...
        paramLiftFns: [_liftFlatS32,_liftFlatS32,_liftFlatS32,_liftFlatS32,_liftFlatS32,_liftFlatS32,_liftFlatS32,_liftFlatS32,_liftFlatS32,_liftFlatS32,_liftFlatS32,_liftFlatS32,_liftFlatS32],
        resultLowerFns: [_lowerFlatS32],
        hasResultPointer: false,
        funcTypeIsAsync: false,
        getCallbackFn: () => null,
      ...
      null,
      {
        ...
        paramLiftFns: [_liftFlatS32,_liftFlatS32,_liftFlatS32,_liftFlatS32,_liftFlatS32,_liftFlatS32],
        resultLowerFns: [_lowerFlatS32],
        hasResultPointer: false,
        funcTypeIsAsync: false,
        getCallbackFn: () => null,
      ...
      null,
      {
        ...
        paramLiftFns: [_liftFlatS32,_liftFlatS64,_liftFlatS8,_liftFlatS32],
        resultLowerFns: [_lowerFlatS32],
        hasResultPointer: false,
        funcTypeIsAsync: false,
        getCallbackFn: () => null,
      ...
      ({ exports: exports0 } = yield instantiateCore(yield module0, {
        'vfs:host/bridge': {
          ...
          '[static]downloader.sysroot-get-archive-meta': trampoline3,
          '[static]downloader.sysroot-read-archive-chunk': trampoline4,
          '[static]downloader.sysroot-start-fetch': trampoline5,
          '[static]http.request-start': trampoline6,
          '[static]http.response-end': trampoline10,
          '[static]http.response-read-body': trampoline8,
          '[static]http.response-read-error': trampoline9,
          '[static]http.response-read-headers': trampoline7,
          '[static]terminal.terminal-write': trampoline1,
        },
        'wasip1-vfs:host/virtual-file-system-wasip1-core': {
          '[static]wasip1.clock-res-get-import': trampoline23,
          '[static]wasip1.clock-time-get-import': trampoline24,
          '[static]wasip1.environ-get-import': trampoline25,
          '[static]wasip1.environ-sizes-get-import': trampoline26,
          '[static]wasip1.fd-close-import': trampoline27,
          '[static]wasip1.fd-fdstat-get-import': trampoline28,
          ...
          '[static]wasip1.path-remove-directory-import': trampoline38,
          '[static]wasip1.path-unlink-file-import': trampoline39,
          '[static]wasip1.proc-exit-import': trampoline40,
          '[static]wasip1.random-get-import': trampoline21,
          '[static]wasip1.sched-yield-import': trampoline22,
        },
        'wasip1-vfs:host/virtual-file-system-wasip1-threads-import': {
          '[static]wasip1-threads.thread-spawn-import': trampoline20,
        },
      }));
      exports0FlushToVfs = exports0['flush-to-vfs'];
      exports0FlushFromVfs = exports0['flush-from-vfs'];
      exports0StartupSysrootLoadState = exports0['startup-sysroot-load-state'];
      exports0StartupSysrootErrorCode = exports0['startup-sysroot-error-code'];
      exports0AdditionalSysrootRegister = exports0['additional-sysroot-register'];
      exports0AdditionalSysrootState = exports0['additional-sysroot-state'];
      exports0AdditionalSysrootErrorCode = exports0['additional-sysroot-error-code'];
      exports0AdditionalSysrootCancel = exports0['additional-sysroot-cancel'];
      exports0AdditionalSysrootRelease = exports0['additional-sysroot-release'];
      ...
      const virtualFileSystemWasip1ThreadsExport = {
        wasiThreadStart: wasiThreadStart,

      };

      return { virtualFileSystemWasip1ThreadsExport, additionalSysrootCancel, additionalSysrootErrorCode, additionalSysrootRegister, additionalSysrootRelease, additionalSysrootState, allocBuf, debugCaptureWaitSnapshot, debugReadTerminalOutput, debugSetTerminalCapture, debugTerminalOutputLen, dispatch, flushFromVfs, flushToVfs, freeBuf, init, main, startupSysrootErrorCode, startupSysrootLoadState, 'wasip1-vfs:host/virtual-file-system-wasip1-threads-export': virtualFileSystemWasip1ThreadsExport,  };
    })();

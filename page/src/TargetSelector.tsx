...
export const TargetSelector = (props: {
  ...
  return (
    <div class="relative w-full min-w-[280px]" ref={dropdownRef}>
      <button
        type="button"
        onClick={handleOpen}
      ...
      >
        <span class="flex items-center gap-2.5">
          <svg class="w-4 h-4 text-green-600/70 group-hover:text-green-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <svg 
          class={`w-4 h-4 text-gray-500 transition-transform duration-300 ${isOpen() ? 'rotate-180 text-green-500' : ''}`} 
          fill="none" 
          stroke="currentColor" 
          viewBox="0 0 24 24"
        >
